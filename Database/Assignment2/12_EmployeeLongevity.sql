...
SELECT concat(E.EmpFirst, ' ', E.EmpLast) as 'Employee Name', p.Title as 'Job Title', W.State, TIMESTAMPDIFF(YEAR,E.StartDate,now()) as 'Years of Employment'
    from Employees as E
        inner join Positions P on E.PositionID = P.PositionID
        inner join Warehouses W on E.WarehouseID = W.WarehouseID
    order by  w.State asc , p.Title asc
;
